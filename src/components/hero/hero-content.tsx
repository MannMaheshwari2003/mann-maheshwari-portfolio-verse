...
const HeroContent = () => {
  return (
    <div className="text-center lg:text-left max-w-2xl">
      <span 
        className="inline-block py-2 px-4 rounded-full text-xs sm:text-sm font-medium bg-primary/10 text-primary mb-4 sm:mb-6 animate-fade-in"
      ...
      <p 
        className="text-base sm:text-lg md:text-xl text-foreground/80 mb-6 sm:mb-8 max-w-lg mx-auto lg:mx-0 px-4 sm:px-0 animate-fade-in"
