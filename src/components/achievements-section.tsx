...
const AchievementsSection = () => {
  return (
    <Section id="achievements" className="bg-card/30 relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 left-1/4 w-32 sm:w-64 h-32 sm:h-64 bg-primary/5 rounded-full filter blur-3xl"></div>
      <div className="absolute bottom-0 right-1/4 w-24 sm:w-40 h-24 sm:h-40 bg-secondary/5 rounded-full filter blur-3xl"></div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
            {achievements.map((achievement, index) => (
              ...
              >
                <div className="glass-card border border-primary/10 p-6 sm:p-8 rounded-xl hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 hover:-translate-y-2 h-full">
